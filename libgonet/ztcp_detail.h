...
class ZTcpServer;
class ZTcpSession
    : /*public Options<ZTcpSession>,*/
    public boost::enable_shared_from_this<ZTcpSession>,
    public SessionBase
{
public:
    struct Msg
    ...
    explicit ZTcpSession(shared_ptr<azmq::socket> s, shared_ptr<LifeHolder> holder,
...
private:
    ...
    shared_ptr<azmq::socket> socket_;
    ...
    friend class ZTcpServer;
};

class ZTcpServer
    : public Options<ZTcpServer>, public ServerBase, public LifeHolder,
    public boost::enable_shared_from_this<ZTcpServer>
{
public:
    typedef std::map<::gonet::SessionEntry, shared_ptr<ZTcpSession>> Sessions;
...
// Tcp客户端
// ZTcpSession与ZTcpClient互相智能指针, 断开连接时才会断开循环引用,
// 因此ZTcpClient析构时一定是连接已经断开, 无需等待.
class ZTcpClient
    : public Options<ZTcpClient>, public ClientBase, public LifeHolder, public boost::enable_shared_from_this<ZTcpClient>
{
public:
    ZTcpClient():sess_(),connect_mtx_(){}
